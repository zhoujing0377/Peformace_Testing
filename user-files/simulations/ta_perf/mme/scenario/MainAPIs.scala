...
class MainAPIs extends Simulation {
...
val scn = scenario("single user comes to customer site")
    ...
    .exec(http("E_MODEL_COMPARE_GET")
            .get(mmeHost + "api/ecommerce/customers/vehicles/model-specs?models=21314210-CBA,21314810-AAA")
            .headers(dcpApiHeader)
            )
    ...
    .exec(http("encryptionWithoutToken")
            ...
            .body(StringBody("""{ "nstCode":"21314210-CBA","productId":"c31ca561-8a9c-4622-90a3-83b1ee7ac871","redirectTo":0,"regCity":"Beijing" }"""))
            .headers(dcpApiHeader)
            .resources()
            )
...
*/
    ...
    .exec(http("get_customers_products")
            .get(mmeHost + "api/ecommerce/customers/products/c31ca561-8a9c-4622-90a3-83b1ee7ac871")
            .headers(dcpApiHeader)
            .headers(headers_with_token)
            )
